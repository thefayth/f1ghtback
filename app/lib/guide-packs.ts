...
export function shouldHoldGuideStep(stepId: string, answer: unknown) {
  return stepId === "identify-papers" && answer === "Different document or unsure"
    || stepId === "confirm-jurisdiction" && answer === "Cross-state connection or unsure";
}
